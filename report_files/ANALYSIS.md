...
├── css/                             # 8 stylesheets
│   ├── style.css                    # Base styles, variables, header, footer, homepage, shop, order-success
│   ├── cart-checkout.css            # Cart & checkout page styles
│   ├── product.css                  # Product detail page styles
│   ├── dashboard.css                # User dashboard styles
│   ├── admin_dashboard.css          # Admin panel + order view styles
│   ├── login.css                    # Login page styles
│   ├── signup.css                   # Signup page styles
│   └── cstyle.css                   # Legacy styles (unused)
...
- All visual styling lives in stylesheets — zero inline CSS in pages (only dynamic PHP values like progress widths, visibility, and active state borders remain inline)
...
9. ~~**Inline CSS in pages** — Visual styles were scattered across PHP files as inline `style=""` attributes.~~ **Resolved** — All migrated to stylesheets; only dynamic PHP-driven values remain inline.
