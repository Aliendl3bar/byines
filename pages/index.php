        ...
        <section class="category-browse" data-purpose="category-browse">
            ...
            <div class="category-grid">
                ...
                foreach ($categories as $cat):
                    $imgSrc = !empty($cat['image_url']) ? htmlspecialchars($cat['image_url']) : '../assets/placeholder.png';
                ?>
                <a class="category-item" href="shop.php?category=<?= urlencode($cat['slug']) ?>" style="text-decoration:none; color:inherit;">
                    <div class="arch-card">
                        <img alt="<?= htmlspecialchars($cat['name']) ?>" src="<?= $imgSrc ?>">
                    </div>
